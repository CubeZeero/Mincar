...
def function_edit(aws_s3_client, gui_layout, gs_default_editkey):
    ...
    if muuid.check_mbl(muuid.get_muuid(), aws_s3_client, aws_info.BUCKET_NAME()):
        ...
        if cancel_sw == 0:
            ...
            if cancel_sw == 0:
                ...
                edit_window = gui_layout.lo_edit_window(coverart_type_list, coverart_download_bytedata_rs, gs_default_editkey)
