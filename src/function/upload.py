...
def function_upload(aws_s3_client, gui_layout, input_disabled_color, default_ca, gs_default_editkey):
    ...
    if muuid.check_mbl(muuid.get_muuid(), aws_s3_client, aws_info.BUCKET_NAME()):
        ...
        try:
            ...
            aws_s3_response = aws_s3_client.list_objects_v2(Bucket = aws_info.BUCKET_NAME(), Prefix = current_disc_info.id + '/')
            ...
            if cancel_sw == 0:
                ...
                upload_window = gui_layout.lo_upload_window(current_disc_info.id, current_disc_info.last_track_num, title_name, input_disabled_color, default_ca, gs_default_editkey)
